...
const CORE_VALUES = [
  ...
  { name: "Transparency", icon: FaScaleBalanced, color: "indigo" as const },
  { name: "Empathy", icon: FaHeart, color: "pink" as const },
  { name: "Results", icon: FaClipboardCheck, color: "indigo" as const },
];
...
export default function AboutPage() {
  return (
    <>
      ...
      {/* Title area – light header (same as education) */}
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              <p className="mt-5 text-slate-600 text-lg max-w-2xl leading-relaxed">
                Pro Consulting has consistently been successful in eliminating myths about visa requirements and bringing smiles to deserving candidates across education and immigration.
              </p>
            </div>
            <Link
              to="/contact"
      ...
      {/* Welcome + intro – trusted partner (same as education) */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: BRAND.pink }} aria-hidden="true">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-[#0B1B3A] mb-6 leading-tight tracking-tight">
            Your trusted partner for study abroad & immigration
          </h2>
          <p className="text-slate-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-8">
            We help students navigate international education with clear visa guidance and direct links to leading universities. We also guide individuals and families through visit, work, family, and settlement visas. Our team cuts through the complexity so you can focus on your goals.
          </p>
          <p className="text-slate-600 leading-relaxed max-w-3xl mx-auto mb-10">
            Pro Consulting works with recognised institutions worldwide and supports you with expert advice on both study abroad and immigration—so you're ready to make the most of your journey.
          </p>
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 rounded-full text-white font-bold px-8 py-3.5 transition-colors shadow-lg"
            style={{ backgroundColor: BRAND.pink }}
          >
            Get in touch <FaArrowRightLong className="w-4 h-4" />
          </Link>
        </div>
      </section>

      {/* Core Values (same as education) */}
            ...
            {CORE_VALUES.map((item) => {
              ...
              return (
                <div
                  ...
                  style={item.color === "pink" ? { backgroundColor: BRAND.pink } : undefined}
                >
      ...
      {/* Our Story timeline (same as education) */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-14">
            <p className="text-sm font-semibold uppercase tracking-wider mb-3" style={{ color: BRAND.pink }}>
              Journey
            </p>
      ...
      {/* Location map (same as education) */}
      ...
      {/* Message from CEO (same as education) */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: BRAND.pink }}>
            From our CEO
          </p>
          <h2 className="text-3xl md:text-4xl font-bold text-[#0B1B3A] mb-8">
            Message from CEO
          </h2>
          <div className="relative pl-6 border-l-4" style={{ borderColor: BRAND.pink }}>
            <FaQuoteLeft className="absolute -left-1 top-0 w-8 h-8 opacity-30" style={{ color: BRAND.pink }} />
            <p className="text-gray-600 leading-relaxed mb-8">
              As the CEO of Pro Consulting, I welcome you to our official website. I assure you this is your right step towards your plan to study abroad in the world's best educational institutions we deal with, or to navigate your immigration journey with confidence. Our vision is to deliver you with unparalleled quality. As a task chief, I assure you that Our Zero Fault Policy makes Pro Consulting a name you can trust and rely on as we successfully navigate your guaranteed career path. &ldquo;Client satisfaction is our main goal.&rdquo; We believe in providing consistently outstanding service, and we believe in 100% satisfaction, rather than just commercial sourcing. Keep in touch with us and we'll surely provide you the best options to build your career. Wishing you luck with your bright future.
            </p>
      ...
      {/* Mission & Vision (same as education) */}
      <section className="py-16 md:py-24 bg-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="rounded-2xl p-8 md:p-10 bg-[#0B1B3A] text-white flex flex-col">
              <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center text-white mb-6 shrink-0">
                <FaBullseye className="w-7 h-7" strokeWidth={2} />
              </div>
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Our Mission</h3>
              <p className="text-white leading-relaxed mb-6 flex-1">
                Our mission is clear — to empower students and families from all corners of the world to access quality education abroad and to navigate immigration pathways with clarity. We are driven by the belief that everyone deserves a chance to achieve their dreams, and we are here to make that journey as smooth as possible.
              </p>
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 font-semibold text-white hover:text-pink-200 transition-colors w-fit"
              >
                Contact us today <FaArrowRightLong className="w-4 h-4" />
              </Link>
            </div>
            <div className="rounded-2xl p-8 md:p-10 text-white flex flex-col" style={{ backgroundColor: BRAND.pink }}>
              <div className="w-14 h-14 rounded-xl bg-white/20 flex items-center justify-center text-white mb-6 shrink-0">
                <FaEye className="w-7 h-7" strokeWidth={2} />
              </div>
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Our Vision</h3>
              <p className="text-white leading-relaxed mb-6 flex-1">
                Pro Consulting was established with a vision to simplify the path to international education and immigration. We are your trusted partners in realizing your academic and visa ambitions on a global stage.
              </p>
              <Link
                to="/contact"
              ...
              >
                Free consultation <FaArrowRightLong className="w-4 h-4" />
              </Link>
            </div>
          </div>
        </div>
