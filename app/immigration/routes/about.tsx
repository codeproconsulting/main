...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "About Us – ProConsulting Immigration" },
    {
      name: "description",
      content:
...
export default function About() {
  return (
    <>
      ...
      {/* Title area – light header (same as main site) */}
              ...
              return (
                <div
                  ...
                  className={`rounded-xl md:rounded-2xl p-6 md:p-8 flex flex-col items-center justify-center text-center min-h-[140px] md:min-h-[180px] ${
                    item.color === "indigo" ? "bg-[#0B1B3A] text-white" : "text-white"
                  }`}
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="relative pl-6 border-l-4" style={{ borderColor: BRAND.pink }}>
            <Quote className="absolute -left-1 top-0 w-8 h-8 opacity-30" style={{ color: BRAND.pink }} />
