...
export function VisitVisaDestinationsSection() {
  return (
    <section
              ...
              >
                <Link to={destination.link} className="block group">
                  <div className="relative aspect-video w-full rounded-2xl overflow-hidden border border-white/10 transition-all duration-300 hover:border-white/30 hover:shadow-xl hover:shadow-black/20">
                    {/* Image (from education site) or gradient + flag fallback */}
                    {"image" in destination && (destination as any).image ? (
                      <img
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, rgba(11,27,58,0.95) 0%, rgba(30,58,110,0.9) 100%)",
                        }}
                      >
                        <img
                          src={(destination as any).flagIcon}
                          alt=""
                    ...
                    <div className="absolute bottom-0 left-0 right-0 flex flex-row justify-between items-end gap-4 p-3 md:p-4 pb-3 md:pb-4">
                      <div>
                        <h3
                          ...
                          style={{
                            textShadow:
                              "0 2px 8px rgba(0,0,0,0.8), 0 0 16px rgba(0,0,0,0.4)",
                          }}
                        >
                          {destination.name}
                        </h3>
                      ...
                      <span
                        className="inline-flex items-center gap-1.5 text-sm font-semibold text-white shrink-0"
                        style={{
